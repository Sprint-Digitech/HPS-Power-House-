...
export const metadata = {
  title: "Earthing – Page 2 – Earthing",
};
...
<h1 class="page-title">
                Earthing            </h1>
<div class="limestone-breadcrumb"><a href="/">Home</a> <span class="separator"><i class="fas fa-angle-double-right"></i></span> <span class="current">Products</span>Page 2</div> </div>
</div>
</div>
...
<p aria-relevant="all" class="woocommerce-result-count" data-is-sorted-by="true" role="alert">
	Showing 13–13 of 13 results<span class="screen-reader-text">Sorted by latest</span></p>
</div>
...
<li class="product type-product post-2893 status-publish first instock product_cat-earthing has-post-thumbnail shipping-taxable product-type-external">
<div class="woocommerce-product-inner">
<div class="product-thumbnail">
<img alt="GI Earthing Electrode" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" decoding="async" fetchpriority="high" height="300" src="/wp-content/uploads/2024/05/GEL-EARTHING-ELECTRODE-1-300x300.png" width="300"/> <div class="cart-button">
...
<a class="prev page-numbers" href="/earthing/page/1/"><i class="far fa-angle-left"></i></a>
<a aria-label="Page 1" class="page-numbers" href="/earthing/page/1/">1</a>
<span aria-current="page" aria-label="Page 2" class="page-numbers current">2</span></nav>
</div>
</div>
</main>
...
`;
const bodyClass = "archive paged post-type-archive post-type-archive-product paged-2 post-type-paged-2 wp-theme-limestone theme-limestone woocommerce-shop woocommerce woocommerce-page woocommerce-no-js woocommerce-active elementor-default elementor-kit-2533";
